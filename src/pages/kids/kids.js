const createKidsPage = () => {
  ...
  <!-- Popular Right now -->
  <div>
    <div class="max-w-[1920px] mx-auto p-6 flex items-center justify-between pl-14">
  ...
  <div class="">
    <div class="max-w-[1920px] mx-auto flex gap-6 mb-6 overflow-x-scroll lg:px-14 px-6">
      <div class="w-full">
        <div class="w-[430px]">
  ...
  <div class="max-w-[1920px] mx-auto p-6 flex items-center justify-between ">
    <h1 class="text-2xl">More to Explore</h1>
  </div>
  <div class="max-w-[1920px] mx-auto flex gap-6 mb-6 overflow-x-scroll xl:overflow-hidden px-6">
    <div class="w-full">
  ...
  <!-- Classic Spotlight -->
  <div class="max-w-[1920px] mx-auto p-6 flex items-center justify-between mt-20">
    <h1 class="text-2xl">Classic Spotlight</h1>
  </div>
  <div class="max-w-[1920px] mx-auto">
    <div class="max-w-[1920px] mx-auto flex gap-6 mb-6 overflow-x-scroll">
      <div class="w-full">
